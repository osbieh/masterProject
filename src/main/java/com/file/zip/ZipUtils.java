...
public class ZipUtils
{
    ...
    private static final String OUTPUT_ZIP_FILE = "D:/Prime.zip";
    private static final String SOURCE_FOLDER = "D:/Prime_UX_Style_Guideline_V3.2.pdf"; // SourceFolder path
