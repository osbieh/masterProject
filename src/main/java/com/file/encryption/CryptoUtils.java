...
public class CryptoUtils {
    ...
    public static File encrypt(String key, File inputFile, File outputFile) throws CryptoException {
        ...
        System.out.println ("File "+inputFile+" with Size "+inputFile.length()+" byte before encrypt");
        doCrypto(Cipher.ENCRYPT_MODE, key, inputFile, outputFile);
        System.out.println ("File "+outputFile+" with Size "+outputFile.length()+" byte after encrypt");
